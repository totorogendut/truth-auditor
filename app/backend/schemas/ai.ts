...
export const seoSuggestionsSchema = z.object({
  keywords: z
    .array(z.string())
    .describe(`Extract SEO-related keywords from the input text.`),
  keywordsDifficulty: z
    .number()
    .min(0)
    .max(100)
    .describe(
      `Calculate SEO keyword difficulty score based on the extracted keywords.`,
    ),
  searchVolume: z
    .number()
    .describe(`Monthly search volume data for the extracted keywords.`),
  traffic: z
    .number()
    .describe(`Estimated monthly traffic generated by the extracted keywords.`),
  position: z
    .number()
    .describe(`Current SEO position or ranking of the extracted keywords.`),
  costPerClick: z
    .number()
    .describe(`Estimated cost per click (CPC) for the extracted SEO keywords.`),
